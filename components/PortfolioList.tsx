  ...
  return (
    <div id="portfolio-list">
      ...
      <div className="portfolio-piece">
        ...
        <section>
          ...
          <div className="app-info">
            <p>Links: <Link to="https://nc-news-evv6.onrender.com/api" target="blank">Hosted API</Link> | <Link to="https://github.com/thomasmullen9999/nc-news" target="blank">GitHub Repo</Link></p>
      ...
      <div className="portfolio-piece">
        ...
        <div className="app-info">
        <p>Links: <Link to="https://thomas-mullen-nc-news.netlify.app/" target="blank">Hosted Site</Link> | <Link to="https://github.com/thomasmullen9999/fe-nc-news" target="blank">GitHub Repo</Link></p>
      ...
      <div className="portfolio-piece">
        ...
        <div className="app-info">
        <p>Links: <Link to="https://thomasmullen9999.github.io/mega-man-walkthrough/introduction.html" target="blank">Hosted Site</Link> | <Link to="https://github.com/thomasmullen9999/mega-man-walkthrough" target="blank">GitHub Repo</Link></p>
      ...
      <div className="portfolio-piece">
        ...
        <div className="app-info">
        <p>Links: <Link to="https://northcoders.com/project-phase/trek-it" target="blank">Video Overview</Link> | <Link to="https://github.com/thomasmullen9999/trek-it-travel" target="blank">GitHub Repo</Link></p>
      ...
      <div className="portfolio-piece">
        ...
        <div className="app-info">
        <p>Links: <Link to="https://thomas-mullen-portfolio.vercel.app/" target="blank">Hosted Site</Link> | <Link to="https://github.com/thomasmullen9999/portfolio" target="blank">GitHub Repo</Link></p>
