const Certifications = () => {
  return (
    <div id="certifications">
      ...
      <h3>
        A selection of my achievements and qualifications related to computer
        science, software development and programming. I have worked to deepen
        my knowledge whilst gaining professional experience.
      </h3>

      <div className="certification">
        <h3>
          MSc Digital Technology Solutions (Level 7) - Northumbria University{" "}
          <b>(IN PROGRESS)</b>
        </h3>
        <section>
          <img
            className="img-right diphe cert-img"
            src="/cer.png"
            alt="MSc (Level 7) - Digital Technology Solutions - Northumbria University certificate of completion"
          ></img>
          <p>description</p>
        </section>
      </div>
      ...
      <div className="certification">
        <h3>
          Diploma of Higher Education (Level 5) - Computer Science - Manchester
        ...
        <section>
          <img
            className="img-right diphe cert-img"
            src="/diphecert.png"
            alt="Manchester Metropolitan University Computer Science Diploma of Higher Education certificate of completion"
          ></img>
          <p>
            At MMU I began my journey in Computer Science and programming, and
      ...
      <div className="certification">
        <h3>
          Meta Front-End Developer <b>(IN PROGRESS)</b>
        </h3>
        <section>
          <img
            className="img-right diphe cert-img"
            src="/cer.png"
            alt="Meta Front-End Developer certificate of completion"
          ></img>
          <p>description</p>
        </section>
      </div>
      ...
      <div className="certification">
        ...
        <section>
          <img
            className="img-right cert-img"
            src="/northcoderscert.png"
            alt="Northcoders certificate of completion"
          ></img>
          <p>
            In 2024 I attended Northcoders, a widely recognised coding bootcamp
      ...
      <div className="certification">
        ...
        <section>
          <img
            className="img-right cert-img"
            src="/cs50xcert.png"
            alt="CS50's Intro to Computer Science certificate of completion"
          ></img>
          <p>
            An intensive course with fantastic lectures delivered by Harvard
      ...
      <div className="certification">
        ...
        <section>
          <img
            className="img-right cert-img"
            src="/cs50sqlcert.png"
            alt="CS50's Introduction to Databases certificate of completion"
          ></img>
          <p>
            This course from Harvard University focusing on SQL was instrumental
