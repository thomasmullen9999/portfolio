...
const Home = () => {
  return (
    <div id="home">
      ...
      <p>The <em>Skills</em> section displays a list of technical skills I am proficient in (languages, frameworks, etc.), whilst the <em>Certifications</em> section contains a selection of awards I have achieved in some relevant courses. The actual list of projects I have worked on can be found in the <em>Portfolio</em> section.</p>
